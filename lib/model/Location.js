...
class Location extends Base {
    ...
    generate (values) {
        ...
        for (let v of values) {
            ret.push(me.isNull ? me : new C(me).advanceColumn(offset));
    ...
    lineCount (from) {
        if (from.isLocation) {
            if (from.file !== this.file) {
                throw new Error(`Cannot do lineCount across files ${this.file} --> ${from.file}`);
            }
...
Location.NULL.isNull = true;

Object.freeze(Location.NULL);
